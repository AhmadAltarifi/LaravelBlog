...
<ol class="breadcrumb" style="margin-top: 10px;">
  ...
  <li dir="auto" class="breadcrumb-item active">{!!$topic->title!!}</li>
</ol>
<div class="row container" style="margin: auto;">
  <div class="leftcolumn">
    <div class="card">
    <h2 dir="auto" style="font-family: hel; text-align: center;">{!!$topic->title!!}</h2>
      <h5>By: <a href="https://www.instagram.com/a7madaltarifi">{!!$topic->firstname!!} {!!$topic->lastname!!}</a></h5>
      <div class="detimage"><img class="img-responsive" src="/storage/topic_image/{{$topic->topic_image}}" alt="{{$topic->topic_image}}" style=" margin: auto;"></div>
      <p>Published At : {!!$topic->created_at!!}</p>
      <p> Share : </p>
                <div class="addthis_inline_share_toolbox" style="margin-left: 10px;"></div>
                <h4 dir="auto" style="font-family: 'SF Display', sans-serif;">{!!$topic->body!!}</h4>
      <a class="btn btn-info" href="/topics" style="margin-top:5px;">Back To Articles</a>
      @if(!Auth::guest())
      <a class="btn btn-success" href="/topics/{{$topic->id}}/edit"style="margin-top:5px;">Edit Post</a>
...
@endif
  ...
  <div class="rightcolumn">
    <!--<div class="card">
      <h3>More Articles</h3>
      <h4>- {!!$topic->title!!}</h4>
      <div class="detimage" style="height: 150px;"><img class="img-responsive" style="height: 150px; margin: auto;" src="/storage/topic_image/{{$topic->topic_image}}" alt="{{$topic->topic_image}}" style=" margin: auto;"></div>
    </div>-->
    <div class="card">
      <!--<h3>Follow Me</h3>
