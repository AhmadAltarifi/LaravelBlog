...
<ol class="breadcrumb" style="margin-top: 10px;">
  ...
  <li class="breadcrumb-item active" style="text-align: right;"><?php echo $post->title; ?></li>
</ol>

<div class="row container" style="margin: auto;">
  <div class="leftcolumn">
    <div class="card">
      <h2 dir="auto" style="font-family: hel; text-align:center;"><?php echo $post->title; ?></h2>
      <h5>By: <a href="https://www.instagram.com/a7madaltarifi"><?php echo $post->firstname; ?> <?php echo $post->lastname; ?></a></h5>
      <div class="detimage"><img class="img-responsive" src="/storage/post_image/<?php echo e($post->post_image); ?>" alt="<?php echo e($post->post_image); ?>" style=" margin: auto;"></div>
      <p>Published At : <?php echo $post->created_at; ?></p>
      <p> Share : </p>
                <div class="addthis_inline_share_toolbox" style="margin-left: 10px;"></div>
      <h4 dir="auto" style="font-family: 'SF Display', sans-serif; "><?php echo $post->body; ?></h4>
      <a class="btn btn-info" href="/posts" style="margin-top:5px;">Back To News</a>
      <?php if(!Auth::guest()): ?>
      <a class="btn btn-success" href="/posts/<?php echo e($post->id); ?>/edit"style="margin-top:5px;">Edit Post</a>
...
<div class=" pb-cmnt-container">
  ...
  <div class="rightcolumn">
    <div class="card">
      <h3>More News</h3>
      <h4  style="font-family: 'El Messiri', sans-serif;">- <?php echo $post->title; ?></h4>
      <div class="detimage" style="height: 150px;"><img class="img-responsive" style="height: 150px; margin: auto;" src="/storage/post_image/<?php echo e($post->post_image); ?>" alt="<?php echo e($post->post_image); ?>" style=" margin: auto;"></div>
    </div>
    <!--
    <div class="card">
      <h3>Follow Me</h3>
...
<?php /**PATH C:\Users\Ahmad Hamad\blog\resources\views/posts/detail.blade.php ENDPATH**/ ?>