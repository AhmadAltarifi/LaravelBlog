...
<body>
    <div id="app">
        <nav class="navbar navbar-default navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(url('/index')); ?>">
                                        Go To Site
                                    </a>
...
<?php /**PATH C:\Users\Ahmad Hamad\Desktop\Palestine\resources\views/layouts/app.blade.php ENDPATH**/ ?>